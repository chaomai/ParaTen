...
import org.chaomai.paratd.tensor.CoordinateTensor
...
object Common {
  ...
  val dim3Tensor: CoordinateTensor[Double] =
    CoordinateTensor.fromFile("src/main/resources/data/test_dim3.tensor",
                              sizeOfDim3Tensor)(sc)

  val sizeOfDim4SparseTensor: IndexedSeq[Int] = IndexedSeq(2, 2, 3, 2)

  val dim4SparseTensor: CoordinateTensor[Double] =
    CoordinateTensor.fromFile("src/main/resources/data/test_dim4.tensor",
  ...
  val dim4DenseTensor: CoordinateTensor[Double] =
    CoordinateTensor.fromFile("src/main/resources/data/test_dim4_dense.tensor",
